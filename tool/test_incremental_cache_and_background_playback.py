...
class IncrementalCacheAndBackgroundPlaybackTest(unittest.TestCase):
    ...
    def test_android_player_is_service_owned_and_hands_off_to_native_file(self):
        ...
        self.assertIn("minBufferDuration: Duration(seconds: 45)", bridge)
        self.assertIn("maxBufferDuration: Duration(minutes: 3)", bridge)
        ...
        self.assertIn("stalledAtBufferedPosition", player)
        self.assertIn("positionProgress || bufferProgress", player)
