...
release for the version in `pubspec.yaml` (for example `v1.4.37`). Non-main
branches use `build-<run number>` prereleases. You can also push a matching
version tag such as `v1.4.37` explicitly.
...
- `TelePlayer-v1.4.37.apk`
- `TelePlayer-v1.4.37-arm64.apk`
- `TelePlayer-v1.4.37-armeabi-v7a.apk`
- `TelePlayer-v1.4.37-x86_64.apk`
- `TelePlayer-v1.4.37-aab.aab`
- `TelePlayer-v1.4.37-Setup.exe`
- `TelePlayer-v1.4.37-windows-x64.zip`
