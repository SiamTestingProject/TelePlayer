...
release for the version in `pubspec.yaml` (for example `v1.4.29`). Non-main
branches use `build-<run number>` prereleases. You can also push a matching
version tag such as `v1.4.29` explicitly.
...
- `TelePlayer-v1.4.29.apk`
- `TelePlayer-v1.4.29-arm64.apk`
- `TelePlayer-v1.4.29-armeabi-v7a.apk`
- `TelePlayer-v1.4.29-x86_64.apk`
- `TelePlayer-v1.4.29-aab.aab`
- `TelePlayer-v1.4.29-Setup.exe`
- `TelePlayer-v1.4.29-windows-x64.zip`
